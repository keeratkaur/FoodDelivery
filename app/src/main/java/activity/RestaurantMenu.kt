...
import adapter.RestaurantRecyclerMenuAdapter
import model.Menu
...
class RestaurantMenu : AppCompatActivity() {
    ...
    lateinit var menuAdapter: RestaurantRecyclerMenuAdapter
    ...
    var restaurantMenuList = arrayListOf<Menu>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activity_restaurant_menu_Progressdialog =
            findViewById(R.id.activity_restaurant_menu_Progressdialog)
