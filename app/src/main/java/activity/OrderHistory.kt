...
class OrderHistory : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        order_activity_history_Progressdialog = findViewById(
            R.id.order_activity_history_Progressdialog
        )

        order_history_fragment_no_orders = findViewById(
            R.id.order_history_fragment_no_orders
        )
