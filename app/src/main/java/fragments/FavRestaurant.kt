...
lateinit var favouriteAdapter: HomeRecyclerAdapter//using the same adapter here as it has the same functionality
lateinit var favourite_restaurant_fragment_Progressdialog: RelativeLayout

var restaurantInfoList = arrayListOf<Restaurant>()

class FavRestaurant(val contextParam: Context) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view= inflater.inflate(R.layout.fragment_fav_restaurant2, container, false)
        ...
        favourite_restaurant_fragment_Progressdialog =
            view.findViewById(R.id.favourite_restaurant_fragment_Progressdialog)
