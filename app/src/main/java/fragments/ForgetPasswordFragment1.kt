...
class ForgetPasswordFragment1(val contextParam: Context, val mobile_number: String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_forget_password1, container, false)
        ...
        forgot_password_fragment_Progressdialog =
            view.findViewById(R.id.forgot_password_fragment_Progressdialog)
                ...
                if (editTextNewPassword.text.isBlank()) {
                    ...
                    if (editTextConfirmPasswordForgot.text.isBlank()) {
                        ...
                        if ((editTextNewPassword.text.toString()
                                .toInt() == editTextConfirmPasswordForgot.text.toString().toInt())
                        ) {
                            if (ConnectionManager().checkConnectivity(activity as Context)) {
                                ...
                                try {
                                    ...
                                    val jsonObjectRequest = object : JsonObjectRequest(
                                        ...
                                        Response.Listener {
                                            ...
                                            forgot_password_fragment_Progressdialog.visibility =
                                                View.INVISIBLE
                                        },
                                ...
                                alterDialog.setPositiveButton("Open Settings") { text, listener ->
                                    val settingsIntent =
                                        Intent(Settings.ACTION_SETTINGS)//open wifi settings
    ...
    fun passwordChanged() {
        val intent= Intent(activity as Context, Sign_In::class.java)
